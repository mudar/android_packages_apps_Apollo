...
public class MusicPlaybackServiceRemote extends Service implements IMusicPlaybackService {
    ...
    public void onCreate() {
        ...
        final Intent shutdownIntent = new Intent(this, MusicPlaybackServiceRemote.class);
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (AppWidgetSmall.CMDAPPWIDGETUPDATE.equals(command)) {
                ...
                mAppWidgetSmall.performUpdate(MusicPlaybackServiceRemote.this, small);
                ...
                mAppWidgetLarge.performUpdate(MusicPlaybackServiceRemote.this, large);
            } else if (AppWidgetLargeAlternate.CMDAPPWIDGETUPDATE.equals(command)) {
                final int[] largeAlt = intent
                        .getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
                mAppWidgetLargeAlternate.performUpdate(MusicPlaybackServiceRemote.this, largeAlt);
                ...
                mRecentWidgetProvider.performUpdate(MusicPlaybackServiceRemote.this, recent);
            } else {
                handleCommandIntent(intent);
            }
        }
    ...
    private static final class MusicPlayerHandler extends Handler {
         ...
         */
        public MusicPlayerHandler(final MusicPlaybackServiceRemote service, final Looper looper) {
            super(looper);
        ...
        public void handleMessage(final Message msg) {
            final MusicPlaybackServiceRemote service = mService.get();
            if (service == null) {
                return;
            }
    ...
    private static final class MultiPlayer implements MediaPlayerRemote.OnErrorListener,
            MediaPlayerRemote.OnCompletionListener {
         ...
         */
        private boolean setDataSourceImpl(final MediaPlayerRemote player, final String path) {
            try {
                player.reset();
         ...
         */
        @Override
        public boolean onError(final MediaPlayerRemote mp, final int what, final int extra) {
            switch (what) {
         ...
         */
        @Override
        public void onCompletion(final MediaPlayerRemote mp) {
    ...
    private static final class ServiceStub extends IApolloService.Stub {
        ...
        private ServiceStub(final MusicPlaybackServiceRemote service) {
            mService = new WeakReference<MusicPlaybackServiceRemote>(service);
        }
